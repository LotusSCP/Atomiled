...
namespace Atomiled.Installer
{
    ...
    using Atomiled.Installer.Properties;
    ...
    internal static class Program
    {
        ...
        internal static async Task MainSafe(CommandSettings args)
        {
            ...
            try
            {
                ...
                ReleaseAsset? AtomiledAsset = targetRelease!.Assets.FirstOrDefault(a => a.Name.Equals(AtomiledAssetName, StringComparison.OrdinalIgnoreCase));
                if (AtomiledAsset is null)
                {
                ...
                Console.WriteLine(FormatAsset(AtomiledAsset));
                ...
                using HttpResponseMessage downloadResult = await httpClient.GetAsync(AtomiledAsset.BrowserDownloadUrl).ConfigureAwait(false);
