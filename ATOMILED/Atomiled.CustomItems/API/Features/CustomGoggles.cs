...
namespace Atomiled.CustomItems.API.Features
{
    ...
    public abstract class CustomGoggles : CustomItem
    {
        ...
        {
            Atomiled.Events.Handlers.Player.UsingItem += OnInternalUsingItem;
            Atomiled.Events.Handlers.Player.ItemRemoved += OnInternalItemRemoved;
            Atomiled.Events.Handlers.Scp1344.Deactivating += OnInternalDeactivating;
            Atomiled.Events.Handlers.Scp1344.ChangedStatus += OnInternalChangedStatus;
            Atomiled.Events.Handlers.Scp1344.ChangingStatus += OnInternalChangingStatus;
