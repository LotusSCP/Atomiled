...
namespace Atomiled.Loader
{
    ...
    public class Loader
    {
        ...
        /// <returns>The desired plugin, null if not found.</returns>
        /// <remarks>This method does not check LabAPI's loaded plugins, only LabAPI plugins ATOMILED loaded.</remarks>
        ...
        public IEnumerator<float> Run(Assembly[] dependencies = null)
        {
            ...
            if (!LoaderPlugin.Config.ShouldLoadOutdatedAtomiled &&
        ...
        private static bool CheckPluginRequiredAtomiledVersion(IPlugin<IConfig> plugin)
        {
            ...
            Version requiredVersion = plugin.RequiredAtomiledVersion;
        ...
        /// <summary>
        /// Load every plugin inside the given directory, if null it's default ATOMILED one (global).
        /// </summary>
        /// <param name="dir">The sub-directory of the plugin - if null the default ATOMILED one will be used.</param>
