// -----------------------------------------------------------------------
// <copyright file="AtomiledLib.cs" company="ExMod Team">
...
namespace Atomiled.Loader.Models
{
    ...
    /// </summary>
    public readonly struct AtomiledLib : IComparable, IComparable<AtomiledLib>
    {
        /// <summary>
        /// The assembly.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AtomiledLib"/> struct.
        /// </summary>
        /// <param name="lib"><inheritdoc cref="Library"/></param>
        public AtomiledLib(Assembly lib)
        {
            Library = lib;
        ...
        /// </returns>
        public int CompareTo(object obj) => obj is AtomiledLib l ? CompareTo(l) : 0;
        ...
        /// Greater than zero This instance follows other in the sort order.
        /// </returns>
        public int CompareTo(AtomiledLib other) => Version.CompareTo(other.Version);
    }
}
