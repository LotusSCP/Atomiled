...
namespace Atomiled.Example.Events
{
    ...
    {
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnDied(DiedEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnChangingRole(ChangingRoleEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnChangingItem(ChangingItemEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Scp106.OnTeleporting(TeleportingEventArgs)"/>
        public void OnTeleporting(TeleportingEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} is teleporting to {ev.Position} as SCP-106!");
        }

        /// <inheritdoc cref="Atomiled.Events.Handlers.Scp914.OnActivating(ActivatingEventArgs)"/>
        public void OnActivating(ActivatingEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} is activating SCP-914!");
        }

        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnFailingEscapePocketDimension(FailingEscapePocketDimensionEventArgs)"/>
        public void OnFailingEscapePocketDimension(FailingEscapePocketDimensionEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} is failing to escape from the pocket dimension!");
        }

        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnEscapingPocketDimension(EscapingPocketDimensionEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Scp914.OnChangingKnobSetting(ChangingKnobSettingEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.Joined"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.UnlockingGenerator"/>
        public void OnUnlockingGenerator(UnlockingGeneratorEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} is trying to unlock a generator in {ev.Player.CurrentRoom} room");
        }

        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.Destroying"/>
        public void OnDestroying(DestroyingEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} ({ev.Player.Role}) is leaving the server!");
        }

        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.Dying"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.PreAuthenticating"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnPickingUpItem(PickingUpItemEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnUsingItem(UsingItemEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnShooting(ShootingEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnReloadingWeapon(PlayerReloadingWeaponEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnReceivingEffect(ReceivingEffectEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Scp914.OnUpgradingPlayer(UpgradingPlayerEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnDroppingItem(DroppingItemEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnSpawned(SpawnedEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.OnEscaping(EscapingEventArgs)"/>
        ...
        /// <inheritdoc cref="Atomiled.Events.Handlers.Player.Hurting"/>
