...
namespace Atomiled.CreditTags.Commands
{
    ...
    /// <summary>
    /// A client command to show an ATOMILED credit tag.
    /// </summary>
    [CommandHandler(typeof(ClientCommandHandler))]
    public class ShowCreditTag : ICommand
    {
        /// <inheritdoc/>
        public string Command { get; } = "Atomiledtag";

        /// <inheritdoc/>
        public string[] Aliases { get; } = new[] { "crtag", "et", "ct" };

        /// <inheritdoc/>
        public string Description { get; } = "Shows your ATOMILED Credits tag, if available.";
