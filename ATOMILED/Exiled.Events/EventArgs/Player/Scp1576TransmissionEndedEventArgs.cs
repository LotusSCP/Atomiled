...
namespace Atomiled.Events.EventArgs.Player
{
    ...
    public class Scp1576TransmissionEndedEventArgs : IPlayerEvent
    {
        ...
        /// <summary>
        /// Gets the <see cref="Atomiled.API.Features.Player"/> that the transmission ended for.
        /// </summary>
        public Player Player { get; }

        /// <summary>
        /// Gets the <see cref="Atomiled.API.Features.Items.Scp1576"/> instance.
        /// </summary>
        public Atomiled.API.Features.Items.Scp1576 Scp1576 { get; }
    }
}
