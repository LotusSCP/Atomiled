...
namespace Atomiled.API.Interfaces
{
        ...
        where TConfig : IConfig
    {
        ...
        /// <summary>
        /// Gets the required version of Atomiled to run the plugin without bugs or incompatibilities.
        /// </summary>
        Version RequiredAtomiledVersion { get; }

        /// <summary>
        /// Gets a value indicating whether a plugin should bypass the required ATOMILED version check.
