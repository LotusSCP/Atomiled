...
namespace Atomiled.API.Features.Doors
{
    ...
    public class AirlockController
    {
        ...
        /// </summary>
        internal static readonly Dictionary<BaseController, AirlockController> BaseToAtomiledControllers = new(new ComponentsEqualityComparer());
        ...
        public AirlockController(BaseController controller)
        {
            ...
            BaseToAtomiledControllers.Add(controller, this);
        }

        /// <summary>
        /// Gets the list with all airlocks.
        /// </summary>
        public static IReadOnlyCollection<AirlockController> List => BaseToAtomiledControllers.Values;
        ...
        public static AirlockController Get(BaseController controller) => controller != null ? (BaseToAtomiledControllers.TryGetValue(controller, out AirlockController airlockController) ? airlockController : new AirlockController(controller)) : null;
        ...
        /// <returns>Instance of <see cref="AirlockController"/>.</returns>
        public static AirlockController Get(Door door) => BaseToAtomiledControllers.Values.FirstOrDefault(x => x.DoorA == door || x.DoorB == door);
