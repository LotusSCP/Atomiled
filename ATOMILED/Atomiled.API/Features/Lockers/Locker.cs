...
#nullable enable
    ...
    public class Locker : IWrapper<BaseLocker>, IWorldSpace, IStructureSync
    {
        ...
        /// </summary>
        internal static readonly Dictionary<BaseLocker, Locker> BaseToAtomiledLockers = new();
        ...
        public Locker(BaseLocker locker)
        {
            ...
            BaseToAtomiledLockers.Add(locker, this);
        ...
        /// </summary>
        public static IReadOnlyCollection<Locker> List => BaseToAtomiledLockers.Values;
        ...
        public static Locker? Get(BaseLocker locker) => locker == null ? null :
            BaseToAtomiledLockers.TryGetValue(locker, out Locker supply) ? supply : new Locker(locker);
        ...
        /// <summary>
        /// Clears the cached lockers in the <see cref="BaseToAtomiledLockers"/> dictionary.
        /// </summary>
        internal static void ClearCache()
        {
            BaseToAtomiledLockers.Clear();
